...
export function emitRuntimeDeclarations(runtime: RuntimeHelperEmitter): string[] {
  ...
  if (runtime.used.has("parseInt") || runtime.used.has("parseFloat") || runtime.used.has("valueToNumber") || runtime.used.has("jsonParseNumber")) declarations.push("declare double @strtod(ptr, ptr)");
  if (runtime.used.has("jsonReviverWalk") || runtime.used.has("jsonStringifyArray")) declarations.push("declare i64 @strlen(ptr)");
...
`);
  ...
  if (runtime.used.has("functionObjectNew")) {
    // Function object payload layout: +0 code, +8 env, +16 bound this,
    // +24 prototype, +32 boxed name value, +40 flags (bit 1: name deleted,
    // bit 2: length deleted), +48 expected argument count (function length).
    definitions.push(`define i64 @functionObjectNew(ptr %code, ptr %env, i64 %boundThis, i64 %name.value, i64 %length) {
entry:
...
`);
  ...
  if (
    runtime.used.has("functionObjectGet") ||
    runtime.used.has("functionObjectHasOwn") ||
    runtime.used.has("functionObjectDelete") ||
    runtime.used.has("functionObjectOwnPropertyDescriptor")
  ) {
...
`);
  ...
  if (runtime.used.has("functionObjectGet")) {
    definitions.push(`define i64 @functionObjectGet(i64 %value, i64 %key.len, ptr %key.ptr) {
entry:
...
`);
  ...
  if (runtime.used.has("functionObjectHasOwn")) {
    definitions.push(`define i1 @functionObjectHasOwn(i64 %value, i64 %key.len, ptr %key.ptr) {
entry:
  %is.name.length = icmp eq i64 %key.len, 4
  br i1 %is.name.length, label %name.compare, label %check.length
name.compare:
...
`);
  ...
  if (runtime.used.has("functionObjectDelete")) {
    definitions.push(`define void @functionObjectDelete(i64 %value, i64 %key.len, ptr %key.ptr) {
entry:
  %function.ptr = call ptr @valueFunctionPtr(i64 %value)
  %flags.slot = getelementptr i8, ptr %function.ptr, i64 40
  %is.name.length = icmp eq i64 %key.len, 4
...
`);
  ...
  if (runtime.used.has("functionObjectOwnPropertyDescriptor")) {
    definitions.push(`define i64 @functionObjectOwnPropertyDescriptor(i64 %value, i64 %key.len, ptr %key.ptr) {
entry:
  %is.name.length = icmp eq i64 %key.len, 4
  br i1 %is.name.length, label %name.compare, label %check.length
name.compare:
...
name.value:
  ...
  %name.missing = icmp eq i64 %name.stored, ${legacyJsValue.immediate("undefined")}
...
name.describe:
  ...
  call void @objectSet(ptr %name.desc, i64 8, ptr @.desc.writable, i64 ${legacyJsValue.immediate("false")})
  call void @objectSet(ptr %name.desc, i64 10, ptr @.desc.enumerable, i64 ${legacyJsValue.immediate("false")})
  call void @objectSet(ptr %name.desc, i64 12, ptr @.desc.configurable, i64 ${legacyJsValue.immediate("true")})
...
length.value:
  ...
  call void @objectSet(ptr %length.desc, i64 8, ptr @.desc.writable, i64 ${legacyJsValue.immediate("false")})
  call void @objectSet(ptr %length.desc, i64 10, ptr @.desc.enumerable, i64 ${legacyJsValue.immediate("false")})
  call void @objectSet(ptr %length.desc, i64 12, ptr @.desc.configurable, i64 ${legacyJsValue.immediate("true")})
...
alloc:
  ...
  %next.fn = call i64 @functionObjectNew(ptr @builtinIteratorNext, ptr %state, i64 ${legacyJsValue.immediate("undefined")}, i64 ${legacyJsValue.immediate("undefined")}, i64 0)
...
array.iter:
  %array.method = call i64 @functionObjectNew(ptr @arrayIteratorMethod, ptr null, i64 ${legacyJsValue.immediate("undefined")}, i64 ${legacyJsValue.immediate("undefined")}, i64 0)
...
string.iter:
  %string.method = call i64 @functionObjectNew(ptr @stringIteratorMethod, ptr null, i64 ${legacyJsValue.immediate("undefined")}, i64 ${legacyJsValue.immediate("undefined")}, i64 0)
...
`);
  ...
  if (runtime.used.has("valueLength")) {
    definitions.push(`@.valuelength.key = private unnamed_addr constant [7 x i8] c"length\\00"
...
object:
  ...
  %raw.tagged = and i64 %raw, ${legacyJsValue.tagMask()}
  %raw.object = icmp eq i64 %raw.tagged, ${legacyJsValue.referenceTag("object")}
  %raw.array = icmp eq i64 %raw.tagged, ${legacyJsValue.referenceTag("array")}
  %raw.string = icmp eq i64 %raw.tagged, ${legacyJsValue.referenceTag("string")}
  %raw.function = icmp eq i64 %raw.tagged, ${legacyJsValue.referenceTag("function")}
  %raw.ref.0 = or i1 %raw.object, %raw.array
  %raw.ref.1 = or i1 %raw.string, %raw.function
  %raw.ref = or i1 %raw.ref.0, %raw.ref.1
  %raw.undefined = icmp eq i64 %raw, ${legacyJsValue.immediate("undefined")}
  %raw.null = icmp eq i64 %raw, ${legacyJsValue.immediate("null")}
  %raw.true = icmp eq i64 %raw, ${legacyJsValue.immediate("true")}
  %raw.false = icmp eq i64 %raw, ${legacyJsValue.immediate("false")}
...
`);
  ...
  if (runtime.used.has("jsonStrOk")) {
    definitions.push(`define { ptr, i64, i64, i1 } @jsonStrOk(ptr %json.ptr, i64 %json.len) {
entry:
...
`);
  ...
  if (runtime.used.has("jsonStrThrow")) {
    definitions.push(`define { ptr, i64, i64, i1 } @jsonStrThrow(i64 %error) {
entry:
...
`);
  ...
  if (runtime.used.has("jsonStackHasValue")) {
    definitions.push(`define i1 @jsonStackHasValue(ptr %stack, i64 %value) {
entry:
...
`);
  ...
  if (runtime.used.has("jsonStringifyValue")) {
    definitions.push(`@.jsonstr.tojson.key = private unnamed_addr constant [7 x i8] c"toJSON\\00"
...
`);
  ...
  if (runtime.used.has("jsonStringifyInner")) {
...
`);
  ...
  if (runtime.used.has("jsonStringify")) {
    definitions.push(`@.jsonstr.empty.key = private unnamed_addr constant [1 x i8] c"\\00"
...
undefined:
  call void @gcRootRestore(i64 %frame)
  %u.0 = insertvalue { i64, i1 } undef, i64 ${legacyJsValue.immediate("undefined")}, 0
...
`);
  ...
  if (runtime.used.has("jsonSkipWhitespace")) {
    definitions.push(`define void @jsonSkipWhitespace(ptr %p, i64 %len, ptr %pos.addr) {
entry:
  br label %loop
loop:
...
`);
  ...
  if (runtime.used.has("jsonMatchLiteral")) {
    definitions.push(`define i1 @jsonMatchLiteral(ptr %p, i64 %len, ptr %pos.addr, ptr %lit, i64 %lit.len) {
entry:
  %pos = load i64, ptr %pos.addr
...
`);
  ...
  if (runtime.used.has("jsonHex4")) {
    definitions.push(`define i64 @jsonHex4(ptr %p, i64 %start) {
entry:
  %v.addr = alloca i64
...
`);
  ...
  if (runtime.used.has("jsonParseString")) {
    definitions.push(`define { ptr, i64, i1 } @jsonParseString(ptr %p, i64 %len, ptr %pos.addr) {
entry:
  %cap = add i64 %len, 1
...
`);
  ...
  if (runtime.used.has("jsonParseNumber")) {
    definitions.push(`define { i64, i1 } @jsonParseNumber(ptr %p, i64 %len, ptr %pos.addr) {
entry:
...
`);
  ...
  if (runtime.used.has("jsonParseValue")) {
    definitions.push(`@.jsonparse.true = private unnamed_addr constant [5 x i8] c"true\\00"
...
true.ok:
  %true.ok.0 = insertvalue { i64, i1 } undef, i64 ${legacyJsValue.immediate("true")}, 0
...
false.ok:
  %false.ok.0 = insertvalue { i64, i1 } undef, i64 ${legacyJsValue.immediate("false")}, 0
...
null.ok:
  %null.ok.0 = insertvalue { i64, i1 } undef, i64 ${legacyJsValue.immediate("null")}, 0
...
`);
  ...
  if (runtime.used.has("jsonParseObject")) {
    definitions.push(`define { i64, i1 } @jsonParseObject(ptr %p, i64 %len, ptr %pos.addr) {
entry:
...
`);
  ...
  if (runtime.used.has("jsonParseArray")) {
    definitions.push(`define { i64, i1 } @jsonParseArray(ptr %p, i64 %len, ptr %pos.addr) {
entry:
  %array = call ptr @arrayNew(i64 0)
  call void @jsonSkipWhitespace(ptr %p, i64 %len, ptr %pos.addr)
  %first.pos = load i64, ptr %pos.addr
...
`);
  ...
  if (runtime.used.has("jsonReviverWalk")) {
    definitions.push(`define { i64, i1 } @jsonReviverWalk(i64 %reviver, i64 %holder, i64 %key.value, i64 %index) {
entry:
  %frame = call i64 @gcRootSave()
...
array.replace:
  %sub.undef = icmp eq i64 %sub.value, ${legacyJsValue.immediate("undefined")}
...
object.replace:
  %w.sub.undef = icmp eq i64 %w.sub.value, ${legacyJsValue.immediate("undefined")}
...
`);
  ...
  if (runtime.used.has("jsonParse")) {
    definitions.push(`@.jsonparse.error.name = private unnamed_addr constant [12 x i8] c"SyntaxError\\00"
...
check.reviver:
  %has.reviver = icmp ne i64 %reviver, ${legacyJsValue.immediate("undefined")}
...
`);
  ...
  if (runtime.used.has("objectOwnPropertyDescriptor") || runtime.used.has("arrayOwnPropertyDescriptor") || runtime.used.has("arrayLengthPropertyDescriptor") || runtime.used.has("functionObjectOwnPropertyDescriptor")) {
